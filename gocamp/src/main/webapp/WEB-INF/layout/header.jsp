            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#projects">캠핑장</a></li>
                        <li class="nav-item"><a class="nav-link" href="#signup">캠핑상품</a></li>
                        <li class="nav-item"><a class="nav-link" href="#signup">공지사항</a></li>
